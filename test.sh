...
#gst-launch-1.0 filesrc location=test.mp4 ! qtdemux name=demux \
#    oggmux name=mux ! tcpserversink host=127.0.0.1 port=9090 \
#    demux.video_0 ! queue ! decodebin ! videoconvert ! queue ! theoraenc ! queue ! mux. !queue !\
#    demux.audio_0 ! queue ! decodebin ! audioconvert ! audioresample ! vorbisenc ! mux. !queue
